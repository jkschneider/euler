...
public class Problem61 {
	static class Figurate {
		...
		public int left() { return p / 100; }
		public int right() { return p % 100; }
	...
	static enum FigurateType { 
		...
		public int iter(int n) {
			...
			case Hexagonal: return n*(2*n-1);
			case Heptagonal: return (n*(5*n-3))/2;
			case Octagonal: default: return n*(3*n-2);
			}
		}
	}
	...
	public static boolean recurseFindNext(Figurate[] select, int n) {
		...
		nextFigurate: for(Figurate next : nexts) {
			for(int i = 0; i < n; i++) {
